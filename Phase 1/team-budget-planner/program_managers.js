...
function displayData(){
    ...
    let empJson = JSON.parse(empObj)
    var tableContent =""
    var startTable = "<table border=1 width=200 align=center><tr><th>Id</th><th>Name</th><th>Age</th></tr>"
    tableContent = "<tr><td>"+empJson[0]+"</td><td>"+empJson[1]+"</td><td>"+empJson[2]+"</td></tr>"
    var endTable = "</table>"
